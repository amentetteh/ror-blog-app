...
RSpec.describe User, type: :model do
  subject { User.new(name: 'Dodzi', photo: 'https://unsplash.com/photos/F_-0BxGuVvo', bio: 'Pediatre', posts_counter: 1) }
  ...
  it 'name should be Dodzi' do
    expect(subject.name).to eql 'Dodzi'
  end
  ...
  it 'bio should be valid' do
    expect(subject.bio).to eql 'Pediatre'
  end
